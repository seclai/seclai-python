...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/solutions/{solution_id}/ai-assistant/knowledge-base".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate knowledge base plan
     ...
     Generate a knowledge base plan via the KB AI assistant.

    Describe what knowledge bases you need in natural language and the assistant will propose a plan
    with create, update, or delete actions. The assistant may also propose creating new sources if
    needed. Review the proposed actions and use the accept or decline endpoint.
