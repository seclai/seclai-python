...
def sync_detailed(
    ...
    *,
    ...
    """Link agents
     ...
     Link one or more agents to a solution by their IDs.

    Pass a JSON body with an `ids` array of agent UUIDs. Already-linked agents are silently ignored.
    Returns the updated solution with all linked resources.
