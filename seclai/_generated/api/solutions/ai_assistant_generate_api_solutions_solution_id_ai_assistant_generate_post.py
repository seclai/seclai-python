...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/solutions/{solution_id}/ai-assistant/generate".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Generate solution plan
     ...
     Generate a comprehensive solution management plan via the solution AI assistant.

    This is the most powerful assistant — it can propose changes across sources, knowledge bases, and
    agents. Describe your goal in natural language and the assistant will create a multi-step plan.
    Review the proposed actions and use the accept or decline endpoint.
