...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/email-domains/{domain_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    `cleanup_note` when the removed domain was Seclai-managed (delegated), reminding the caller to
    delete the registrar NS delegation record (dangling-delegation / subdomain-takeover guard).
    Owner/admin only.
