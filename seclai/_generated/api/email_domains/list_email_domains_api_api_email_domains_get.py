...
def sync_detailed(
    *,
    ...
    domains with their verification status, the DNS records the customer must publish, and the plan
    capabilities (`can_add_vanity`/`can_add_custom`) plus whether one of each kind already exists
