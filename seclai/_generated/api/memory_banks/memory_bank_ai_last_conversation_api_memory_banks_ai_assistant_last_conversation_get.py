...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/memory_banks/ai-assistant/last-conversation",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        limit (int | Unset): Max turns to return. Default: 5.
        offset (int | Unset): Number of most-recent turns to skip. Default: 0.
