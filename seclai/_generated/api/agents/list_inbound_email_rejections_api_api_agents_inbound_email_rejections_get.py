...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/agents/inbound-email-rejections",
        "params": params,
    }
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = InboundEmailRejectionResponse.from_dict(
...
def sync_detailed(
    *,
    ...
    unknown alias, spam/virus, flood-shed) for this account's agents.
