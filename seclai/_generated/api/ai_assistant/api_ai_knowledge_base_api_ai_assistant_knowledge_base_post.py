...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/ai-assistant/knowledge-base",
    }
...
def sync_detailed(
    *,
    ...
    """Generate a knowledge base plan (standalone)
     ...
     Generate a knowledge base creation/modification plan without requiring an existing solution. May
    also propose prerequisite source creation actions.
