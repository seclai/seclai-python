...
T = TypeVar("T", bound="ApiCallListResponse")


@_attrs_define
class ApiCallListResponse:
    """
    Attributes:
        data (list[Any]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_call_list_response = cls(
            data=data,
            pagination=pagination,
        )

        api_call_list_response.additional_properties = d
        return api_call_list_response
