...
if TYPE_CHECKING:
    from ..models.branch_current_state_response_dependencies_type_0_additional_property import (
        BranchCurrentStateResponseDependenciesType0AdditionalProperty,
    )


T = TypeVar("T", bound="BranchCurrentStateResponseDependenciesType0")
...
class BranchCurrentStateResponseDependenciesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        branch_current_state_response_dependencies_type_0 = cls()
    ...
    def __setitem__(self, key: str, value: BranchCurrentStateResponseDependenciesType0AdditionalProperty) -> None:
