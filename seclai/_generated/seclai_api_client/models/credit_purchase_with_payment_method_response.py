...
T = TypeVar("T", bound="CreditPurchaseWithPaymentMethodResponse")


@_attrs_define
class CreditPurchaseWithPaymentMethodResponse:
    """
    Attributes:
        message (str):
        success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credit_purchase_with_payment_method_response = cls(
            message=message,
            success=success,
        ...
        credit_purchase_with_payment_method_response.additional_properties = d
        return credit_purchase_with_payment_method_response
