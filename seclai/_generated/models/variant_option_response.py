...
class VariantOptionResponse:
    ...
    long_context_input_cache_hit_credits_per_1000_tokens: float | None | Unset = UNSET
    long_context_input_credits_per_1000_tokens: float | None | Unset = UNSET
    long_context_output_credits_per_1000_tokens: float | None | Unset = UNSET
    long_context_threshold: int | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        long_context_input_cache_hit_credits_per_1000_tokens: float | None | Unset
        if isinstance(self.long_context_input_cache_hit_credits_per_1000_tokens, Unset):
            long_context_input_cache_hit_credits_per_1000_tokens = UNSET
        else:
            long_context_input_cache_hit_credits_per_1000_tokens = (
                self.long_context_input_cache_hit_credits_per_1000_tokens
            )

        long_context_input_credits_per_1000_tokens: float | None | Unset
        if isinstance(self.long_context_input_credits_per_1000_tokens, Unset):
            long_context_input_credits_per_1000_tokens = UNSET
        else:
            long_context_input_credits_per_1000_tokens = (
                self.long_context_input_credits_per_1000_tokens
            )

        long_context_output_credits_per_1000_tokens: float | None | Unset
        if isinstance(self.long_context_output_credits_per_1000_tokens, Unset):
            long_context_output_credits_per_1000_tokens = UNSET
        else:
            long_context_output_credits_per_1000_tokens = (
                self.long_context_output_credits_per_1000_tokens
            )

        long_context_threshold: int | None | Unset
        if isinstance(self.long_context_threshold, Unset):
            long_context_threshold = UNSET
        else:
        ...
        if long_context_input_cache_hit_credits_per_1000_tokens is not UNSET:
            field_dict["long_context_input_cache_hit_credits_per_1000_tokens"] = (
                long_context_input_cache_hit_credits_per_1000_tokens
            )
        if long_context_input_credits_per_1000_tokens is not UNSET:
            field_dict["long_context_input_credits_per_1000_tokens"] = (
                long_context_input_credits_per_1000_tokens
            )
        if long_context_output_credits_per_1000_tokens is not UNSET:
            field_dict["long_context_output_credits_per_1000_tokens"] = (
                long_context_output_credits_per_1000_tokens
            )
        if long_context_threshold is not UNSET:
            field_dict["long_context_threshold"] = long_context_threshold
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_long_context_input_cache_hit_credits_per_1000_tokens(
            data: object,
        ) -> float | None | Unset:
            if data is None:
                return data
        ...
        long_context_input_cache_hit_credits_per_1000_tokens = (
            _parse_long_context_input_cache_hit_credits_per_1000_tokens(
                d.pop("long_context_input_cache_hit_credits_per_1000_tokens", UNSET)
            )
        )
        ...
        long_context_input_credits_per_1000_tokens = (
            _parse_long_context_input_credits_per_1000_tokens(
                d.pop("long_context_input_credits_per_1000_tokens", UNSET)
            )
        )

        def _parse_long_context_output_credits_per_1000_tokens(
            data: object,
        ) -> float | None | Unset:
            if data is None:
                return data
        ...
        long_context_output_credits_per_1000_tokens = (
            _parse_long_context_output_credits_per_1000_tokens(
                d.pop("long_context_output_credits_per_1000_tokens", UNSET)
            )
        )

        def _parse_long_context_threshold(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        long_context_threshold = _parse_long_context_threshold(
            d.pop("long_context_threshold", UNSET)
        )
        ...
        variant_option_response = cls(
            ...
            long_context_input_cache_hit_credits_per_1000_tokens=long_context_input_cache_hit_credits_per_1000_tokens,
            long_context_input_credits_per_1000_tokens=long_context_input_credits_per_1000_tokens,
            long_context_output_credits_per_1000_tokens=long_context_output_credits_per_1000_tokens,
