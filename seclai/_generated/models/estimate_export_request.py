...
if TYPE_CHECKING:
    from ..models.estimate_export_request_metadata_filter_type_0 import (
        EstimateExportRequestMetadataFilterType0,
    )


T = TypeVar("T", bound="EstimateExportRequest")


@_attrs_define
class EstimateExportRequest:
    """Parameters for estimating export size.
    ...
    Attributes:
        ...
        metadata_filter (EstimateExportRequestMetadataFilterType0 | None | Unset): JSONB containment filter applied to
            content metadata.
    ...
    metadata_filter: EstimateExportRequestMetadataFilterType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.metadata_filter, EstimateExportRequestMetadataFilterType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata_filter(
            data: object,
        ) -> EstimateExportRequestMetadataFilterType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                metadata_filter_type_0 = (
                    EstimateExportRequestMetadataFilterType0.from_dict(data)
                )

                return metadata_filter_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EstimateExportRequestMetadataFilterType0 | None | Unset, data)
        ...
        estimate_export_request.additional_properties = d
        return estimate_export_request
