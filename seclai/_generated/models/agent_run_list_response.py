...
T = TypeVar("T", bound="AgentRunListResponse")
...
class AgentRunListResponse:
    """
    Attributes:
        data (list[AgentRunResponse]): List of agent runs.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = AgentRunResponse.from_dict(data_item_data)

            data.append(data_item)

        pagination = PaginationResponse.from_dict(d.pop("pagination"))

        agent_run_list_response = cls(
            data=data,
            pagination=pagination,
        )

        agent_run_list_response.additional_properties = d
        return agent_run_list_response
