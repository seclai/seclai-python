...
if TYPE_CHECKING:
    from ..models.evaluation_result_response_details_type_0 import (
        EvaluationResultResponseDetailsType0,
    )


T = TypeVar("T", bound="EvaluationResultResponse")
...
class EvaluationResultResponse:
    ...
    Attributes:
        ...
        details (EvaluationResultResponseDetailsType0 | None | Unset): Evaluation details including explanation and raw
            LLM response.
    ...
    retry_triggered: bool
    status: str
    details: EvaluationResultResponseDetailsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.details, Unset):
            details = UNSET
        elif isinstance(self.details, EvaluationResultResponseDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_details(
            data: object,
        ) -> EvaluationResultResponseDetailsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                details_type_0 = EvaluationResultResponseDetailsType0.from_dict(data)

                return details_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EvaluationResultResponseDetailsType0 | None | Unset, data)
        ...
        evaluation_result_response = cls(
            agent_run_id=agent_run_id,
            agent_step_run_id=agent_step_run_id,
            created_at=created_at,
            criteria_id=criteria_id,
        ...
        evaluation_result_response.additional_properties = d
        return evaluation_result_response
